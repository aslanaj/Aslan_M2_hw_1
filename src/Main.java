public class Main {
    public static void main(String[] args) {
        ...
        Voleyball voleyball = new Voleyball(TypeOfSport.GROUND,stadium,12,20,"Aslan");
        System.out.println(voleyball.getInfo());
        voleyball.goPass();
        voleyball.goPass("pass!");
        System.out.println("----------------------------------------------");
        Stadium stadium1 = new Stadium("national","Chui 2");
        Pioneerball pioneerball = new Pioneerball(TypeOfSport.GROUND,stadium1,12,10,"Mike",2);
